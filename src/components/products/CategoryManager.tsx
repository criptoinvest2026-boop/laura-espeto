...
export default function CategoryManager() {
  const { categories, createCategory, deleteCategory, isLoading } = useCategories();
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>Os produtos dessa categoria não serão excluídos.</AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
